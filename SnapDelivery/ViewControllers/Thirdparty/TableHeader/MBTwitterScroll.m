...
- (void) setupView:(UIImage*)backgroundImage avatarImage:(UIImage *)avatarImage titleString:(NSString *)titleString subtitleString:(NSString *)subtitleString buttonTitle:(NSString *)buttonTitle scrollHeight:(CGFloat)height type:(MBType)type {
    ...
    // Header
    self.header = [[UIView alloc] initWithFrame:CGRectMake(self.frame.origin.x, self.frame.origin.y, self.frame.size.width, 180)];
    ...
    self.avatarImage = [[UIImageView alloc] initWithFrame:CGRectMake(10,145, 69, 69)];
    ...
    UILabel * titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(12,220, 250, 25)];
    titleLabel.text = titleString;
    titleLabel.textColor = [UIColor darkGrayColor];
    titleLabel.font = [UIFont fontWithName:@"infini" size:16];
    ...
    self.headerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0,0,260,180)];
    ...
    self.avatarImage.layer.borderColor = [UIColor colorWithRed:0.12 green:0.49 blue:0.45 alpha:1].CGColor;
