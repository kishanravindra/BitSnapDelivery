...
#define OKBUTTON_BGCOLOR [UIColor colorWithRed:0.12 green:0.49 blue:0.45 alpha:1]
#define CANCELBUTTON_BGCOLOR [UIColor colorWithRed:0.23 green:0.73 blue:0.58 alpha:1]
//按钮起始tag
#define TAG 100
...
- (void)controlsInit
{
    ...
    _detailLabel  = [[UILabel alloc] initWithFrame:CGRectMake(x ,y + height / 2 + (Title_Font + 5), width,Detial_Font+40)];
