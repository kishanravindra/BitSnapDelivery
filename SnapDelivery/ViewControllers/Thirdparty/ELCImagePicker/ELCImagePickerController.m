...
- (BOOL)shouldSelectAsset:(ELCAsset *)asset previousCount:(NSUInteger)previousCount
{
    ...
    if (!shouldSelect)
    {
       ...
       /* [[[UIAlertView alloc] initWithTitle:title
        ...
        [self customAlertView:WKAlertViewStyleWaring isAlertTitle:title isAlertDetail:message isCancelTitle:nil andOkButtontitle:@"Okay"];
    }
    return shouldSelect;
}
...
- (void)selectedAssets:(NSArray *)assets
{
    ...
    NSLog(@"final count %d",_totalcount);
    if (_totalcount < 5)
    {
       [self customAlertView:WKAlertViewStyleWaring isAlertTitle:nil isAlertDetail:@"You have pick 6 snaps minimum" isCancelTitle:nil andOkButtontitle:@"Okay"];
    }
    else
    {
